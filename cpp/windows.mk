...
pubnub_callback_sample.exe: samples\pubnub_sample.cpp $(SOURCEFILES) ..\core\pubnub_timer_list.c ..\windows\pubnub_ntf_callback_windows.c pubnub_futres_windows.cpp
	$(CXX) /Fe$@ -D PUBNUB_CALLBACK_API $(CFLAGS) -D VERBOSE_DEBUG samples\pubnub_sample.cpp ..\core\pubnub_timer_list.c ..\windows\pubnub_ntf_callback_windows.c pubnub_futres_windows.cpp $(SOURCEFILES) /link ws2_32.lib rpcrt4.lib user32.lib
...
pubnub_callback_cpp11_sample.exe: samples\pubnub_sample.cpp $(SOURCEFILES) ..\core\pubnub_timer_list.c ..\windows\pubnub_ntf_callback_windows.c pubnub_futres_cpp11.cpp
	$(CXX) /Fe$@ /D PUBNUB_CALLBACK_API $(CFLAGS) /D VERBOSE_DEBUG samples\pubnub_sample.cpp ..\core\pubnub_timer_list.c ..\windows\pubnub_ntf_callback_windows.c pubnub_futres_cpp11.cpp $(SOURCEFILES) /link ws2_32.lib rpcrt4.lib user32.lib
...
subscribe_publish_callback_sample.exe: samples\subscribe_publish_callback_sample.cpp $(SOURCEFILES) ..\core\pubnub_timer_list.c ..\windows\pubnub_ntf_callback_windows.c pubnub_futres_windows.cpp
	$(CXX) /Fe$@ -D PUBNUB_CALLBACK_API $(CFLAGS) -D VERBOSE_DEBUG samples\subscribe_publish_callback_sample.cpp ..\core\pubnub_timer_list.c ..\windows\pubnub_ntf_callback_windows.c pubnub_futres_windows.cpp $(SOURCEFILES) /link ws2_32.lib rpcrt4.lib user32.lib
...
futres_nesting_callback.exe: samples\futres_nesting.cpp $(SOURCEFILES) ..\core\pubnub_timer_list.c ..\windows\pubnub_ntf_callback_windows.c pubnub_futres_windows.cpp
	$(CXX) /Fe$@ -D PUBNUB_CALLBACK_API $(CFLAGS)  samples\futres_nesting.cpp ..\core\pubnub_timer_list.c ..\windows\pubnub_ntf_callback_windows.c pubnub_futres_windows.cpp $(SOURCEFILES) /link ws2_32.lib rpcrt4.lib user32.lib
#-D VERBOSE_DEBUG
...
futres_nesting_callback_cpp11.exe: samples\futres_nesting.cpp $(SOURCEFILES) ..\core\pubnub_timer_list.c ..\windows\pubnub_ntf_callback_windows.c pubnub_futres_cpp11.cpp
	$(CXX) /Fe$@ -D PUBNUB_CALLBACK_API $(CFLAGS)  samples\futres_nesting.cpp ..\core\pubnub_timer_list.c ..\windows\pubnub_ntf_callback_windows.c pubnub_futres_cpp11.cpp $(SOURCEFILES) /link ws2_32.lib rpcrt4.lib  user32.lib
#-D VERBOSE_DEBUG
