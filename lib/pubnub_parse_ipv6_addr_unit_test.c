...
Ensure(pubnub_parse_ipv6_addr, parses_some_Ipv6_addresses)
{
    ...
    uint8_t key1[16] = { 0x26, 0x20, 0x01, 0x19, 0,    0x01, 0, 0x35,
                         0,    0,    0,    0,    0xaf, 0,    0, 0x35 };
    uint8_t key2[16] = { 0x26, 0x20, 0x01, 0x19, 0, 0x01, 0, 0x35,
                         0xaf, 0,    0,    0x35, 0, 0,    0, 0x0e };
    uint8_t key3[16] = { 0x26, 0x20, 0x01, 0x19, 0, 0x01,
                         0,    0x35, 0xaf, 0,    0, 0x35 };
    uint8_t key4[16] = {
        0,
        0x0a,
        0,
