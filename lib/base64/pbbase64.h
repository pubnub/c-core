...
#define PBBASE64_ENC_RFC1421 "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/"

/** Base64 transfer encoding for MIME (RFC 2045)*/
#define PBBASE64_ENC_RFC2045 "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/"

/** Standard 'base64' encoding for RFC 3548 or RFC 4648 */
#define PBBASE64_ENC_RFC3548 "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/"

/** 'Radix-64' encoding for OpenPGP (RFC 4880) */
#define PBBASE64_ENC_RFC4880 "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/"

/** Modified Base64 encoding for UTF-7 (RFC 1642, obsoleted) */
#define PBBASE64_ENC_RFC1642 "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/"

/** Modified Base64 encoding for IMAP mailbox names (RFC 3501) */
#define PBBASE64_ENC_RFC3501 "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+,"

/** Standard 'base64url' with URL and Filename Safe Alphabet (RFC 4648
    §5 'Table 2: The "URL and Filename safe" Base 64 Alphabet') */
#define PBBASE64_ENC_RFC4648 "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_"
...
#define PBBASE64_ENC_XML_TOKEN "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789.-"

/** Modified Base64 for XML identifiers (Name) */
#define PBBASE64_ENC_XML_IDENT "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789_:"
...
#define PBBASE64_ENC_NON_STD_REGEX "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789!-"

/** Non-standard URL-safe Modification of Base64 used in Freenet */
#define PBBASE64_ENC_NON_STD_URL "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789~-"
...
*/
pubnub_bymebl_t pbbase64_encode_alloc(pubnub_bymebl_t data, struct pbbase64_options const* options);
...
int pbbase64_decode_str(char const* s, pubnub_bymebl_t *data, struct pbbase64_options const* options);
...
*/
pubnub_bymebl_t pbbase64_decode_alloc(char const* s, size_t n, struct pbbase64_options const* options);

/** Has the effect of ppbase64_decode_alloc(s, strlen(s), options) */
pubnub_bymebl_t pbbase64_decode_alloc_str(char const* s, struct pbbase64_options const* options);
