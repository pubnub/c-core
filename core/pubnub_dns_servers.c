...
#if PUBNUB_USE_LOGGER
    PUBNUB_LOG_DEBUG(
        pb, "Set primary IPv4 DNS server from string: %s", ipv4_str);
#else  // !PUBNUB_USE_LOGGER
    PUBNUB_UNUSED(pb);
#endif // PUBNUB_USE_LOGGER
...
#if PUBNUB_USE_LOGGER
    PUBNUB_LOG_DEBUG(
        pb, "Set secondary IPv4 DNS server from string: %s", ipv4_str);
#else  // !PUBNUB_USE_LOGGER
    PUBNUB_UNUSED(pb);
#endif // PUBNUB_USE_LOGGER
...
int pubnub_get_dns_primary_server_ipv4(
    pubnub_t*                   pb,
...
int pubnub_get_dns_secondary_server_ipv4(
    pubnub_t*                   pb,
    struct pubnub_ipv4_address* o_ipv4)
{
    int            ret;
...
#if PUBNUB_USE_LOGGER
    PUBNUB_LOG_DEBUG(
        pb, "Set primary IPv6 DNS server from string: %s", ipv6_str);
#else  // !PUBNUB_USE_LOGGER
    PUBNUB_UNUSED(pb);
#endif // PUBNUB_USE_LOGGER
...
#if PUBNUB_USE_LOGGER
    PUBNUB_LOG_DEBUG(
        pb, "Set secondary IPv6 DNS server from string: %s", ipv6_str);
#else  // !PUBNUB_USE_LOGGER
    PUBNUB_UNUSED(pb);
#endif // PUBNUB_USE_LOGGER
...
int pubnub_get_dns_primary_server_ipv6(
    pubnub_t*                   pb,
    struct pubnub_ipv6_address* o_ipv6)
{
    ...
    if (memcmp(
            m_primary_dns_server_ipv6.ipv6,
            zero,
            sizeof m_primary_dns_server_ipv6.ipv6) == 0) {
        ret = -1;
    }
    else {
        memcpy(
...
int pubnub_get_dns_secondary_server_ipv6(
    pubnub_t*                   pb,
    struct pubnub_ipv6_address* o_ipv6)
{
    int            ret;
    ...
    if (memcmp(
            m_secondary_dns_server_ipv6.ipv6,
            zero,
            sizeof m_secondary_dns_server_ipv6.ipv6) == 0) {
        ret = -1;
    }
    else {
        memcpy(
