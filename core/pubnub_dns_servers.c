...
static struct pubnub_ipv4_address
    m_primary_dns_server_ipv4 pubnub_guarded_by(m_lock);
static struct pubnub_ipv4_address
    m_secondary_dns_server_ipv4 pubnub_guarded_by(m_lock);
#if PUBNUB_USE_IPV6
static struct pubnub_ipv6_address
    m_primary_dns_server_ipv6 pubnub_guarded_by(m_lock);
static struct pubnub_ipv6_address
    m_secondary_dns_server_ipv6 pubnub_guarded_by(m_lock);
...
int pubnub_dns_set_primary_server_ipv4(
    struct pubnub_ipv4_address ipv4_address) {
    uint8_t* ipv4 = ipv4_address.ipv4;

    PUBNUB_LOG_TRACE(
        "pubnub_dns_set_primary_server_ipv4(%u.%u.%u.%u).\n",
        ipv4[0],
        ipv4[1],
        ipv4[2],
        ipv4[3]);
...
int pubnub_dns_set_secondary_server_ipv4(
    ...
    PUBNUB_LOG_TRACE(
        "pubnub_dns_set_secondary_server_ipv4(%u.%u.%u.%u)\n",
        ipv4[0],
        ipv4[1],
        ipv4[2],
        ipv4[3]);
...
int pubnub_get_dns_primary_server_ipv4(struct pubnub_ipv4_address* o_ipv4) {
    ...
    PUBNUB_LOG_TRACE(
        "pubnub_dns_get_primary_server_ipv4(%u.%u.%u.%u).\n",
        ipv4[0],
        ipv4[1],
        ipv4[2],
        ipv4[3]);
...
int pubnub_get_dns_secondary_server_ipv4(struct pubnub_ipv4_address* o_ipv4) {
    ...
    PUBNUB_LOG_TRACE(
        "pubnub_dns_get_secondary_server_ipv4(%u.%u.%u.%u).\n",
        ipv4[0],
        ipv4[1],
        ipv4[2],
        ipv4[3]);
...
#if PUBNUB_USE_IPV6
int pubnub_dns_set_primary_server_ipv6(
...
int pubnub_dns_set_secondary_server_ipv6_str(char const* ipv6_str) {
    ...
    PUBNUB_ASSERT_OPT(ipv6_str != NULL);
    PUBNUB_LOG_TRACE(
        "pubnub_dns_set_secondary_server_ipv6_str(%s)\n",
        ipv6_str);
