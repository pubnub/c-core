...
/** Initialize the element of the list - so that it is not
    ...
    @pre pbp != NULL
    */
PUBNUB_EXTERN void pubnub_timer_list_init(pubnub_t *pbp);
 ...
 */
PUBNUB_EXTERN pubnub_t *pubnub_timer_list_add(pubnub_t *list, pubnub_t *to_add, int timeout_ms);
...
/** Remove/dequeue a Pubnub context from a list of contexts/timers.
    ...
    @return The head of the list (may differ from @p list)
 */
PUBNUB_EXTERN pubnub_t *pubnub_timer_list_remove(pubnub_t *list, pubnub_t *to_remove);
 ...
 */
PUBNUB_EXTERN pubnub_t *pubnub_timer_list_as_time_goes_by(pubnub_t **pplist, int time_passed_ms);

/** Returns a pointer to the next element in the list for the given
    element @p p.
    @pre p != NULL
    */
PUBNUB_EXTERN pubnub_t *pubnub_timer_list_next(pubnub_t *p);

/** Returns a pointer to the previous element in the list for the given
    element @p p.
    @pre p != NULL
    */
PUBNUB_EXTERN pubnub_t *pubnub_timer_list_previous(pubnub_t *p);
