PROJECT_SOURCEFILES = pubnub_pubsubapi.c pubnub_coreapi.c pubnub_ccore_pubsub.c pubnub_ccore.c pubnub_url_encode.c pubnub_netcore.c pubnub_alloc_static.c pubnub_assert_std.c pubnub_json_parse.c pubnub_keep_alive.c ..\core\pubnub_helper.c ..\core\c99\snprintf.c ..\core\pbcc_advanced_history.c ..\core\pubnub_advanced_history.c ..\lib\pb_strnlen_s.c ..\lib\pb_strncasecmp.c pubnub_generate_uuid.c pubnub_logger.c pbcc_logger_manager.c pubnub_log_value.c pubnub_stdio_logger.c

all: pubnub_proxy_NTLM_test.exe

CFLAGS =-D PUBNUB_ADVANCED_KEEP_ALIVE=1 -D PUBNUB_USE_LOGGER=1 -D PUBNUB_USE_DEFAULT_LOGGER=1 -D PUBNUB_LOG_MIN_LEVEL=NONE -D PUBNUB_RECEIVE_GZIP_RESPONSE=0 -D PUBNUB_DYNAMIC_REPLY_BUFFER=1 -D HAVE_STRERROR_S -I. -I..\ -I ..\core\c99 -I test -I..\lib\base64 -I..\lib\md5
