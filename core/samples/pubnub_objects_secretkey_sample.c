...
int main() {
    ...
    */
    ...
    printf(
        "pubnub_getall_uuidmetadata() lasted %lf seconds.\n",
        difftime(time(NULL), t0));
    if (PNR_OK == res) {
        char const* getall_uuidmetadata_resp = pubnub_get(pbp);
        printf(
            "pubnub_getall_uuidmetadata() Response from Pubnub: %s\n",
            getall_uuidmetadata_resp);
    } else if (PNR_OBJECTS_API_ERROR == res) {
        char const* getall_uuidmetadata_resp = pubnub_get(pbp);
        printf(
            "pubnub_getall_uuidmetadata() failed on Pubnub, description: %s\n",
            getall_uuidmetadata_resp);
    } else {
        printf(
            "pubnub_getall_uuidmetadata() failed with code: %d('%s')\n",
            res,
    ...
    printf(
        "pubnub_get_uuidmetadata() lasted %lf seconds.\n",
        difftime(time(NULL), t0));
    if (PNR_OK == res) {
        char const* get_uuidmetadata_resp = pubnub_get(pbp);
        printf(
            "pubnub_get_uuidmetadata() Response from Pubnub: %s\n",
            get_uuidmetadata_resp);
    } else {
        printf(
            "pubnub_get_uuidmetadata() failed with code: %d('%s')\n",
            res,
            pubnub_res_2_string(res));
    }
    printf("\n\n");
    ...
    printf(
        "pubnub_remove_uuidmetadata() lasted %lf seconds.\n",
        difftime(time(NULL), t0));
    if (PNR_OK == res) {
        char const* remove_uuidmetadata_resp = pubnub_get(pbp);
        printf(
            "pubnub_remove_uuidmetadata() Response from Pubnub: %s\n",
            remove_uuidmetadata_resp);
    } else {
        printf(
            "remove_uuidmetadata_resp() failed with code: %d('%s')\n",
            res,
            pubnub_res_2_string(res));
    }
    printf("\n\n");
    ...
    time(&t0);
    char set_uuidmeta_json[20000] =
        "{\"name\":\"ccoreuuid\",\"externalId\":\"ccore-external-id\",\"profileUrl\":\"ccore@profileurl.com\",\"email\":\"ccore@test.com\",\"custom\":{\"color\":\"red\"}}";
    res =
        pubnub_set_uuidmetadata(pbp, uuid_metadata_id, NULL, set_uuidmeta_json);
    ;
    if (PNR_STARTED == res) {
        res = pubnub_await(pbp);
    }
    printf(
        "pubnub_set_uuidmetadata() lasted %lf seconds.\n",
        difftime(time(NULL), t0));
    if (PNR_OK == res) {
        char const* set_uuidmetadata_resp = pubnub_get(pbp);
        printf(
            "pubnub_set_uuidmetadata() Response from Pubnub: %s\n",
            set_uuidmetadata_resp);
    } else {
        printf(
            "pubnub_set_uuidmetadata() failed with code: %d('%s')\n",
            res,
            pubnub_res_2_string(res));
    }
    printf("\n\n");
    ...
    printf(
        "pubnub_getall_channelmetadata() lasted %lf seconds.\n",
        difftime(time(NULL), t0));
    if (PNR_OK == res) {
        char const* getall_channelmetadata_resp = pubnub_get(pbp);
        printf(
            "pubnub_getall_channelmetadata() Response from Pubnub: %s\n",
            getall_channelmetadata_resp);
    } else if (PNR_OBJECTS_API_ERROR == res) {
        char const* getall_channelmetadata_resp = pubnub_get(pbp);
        printf(
            "pubnub_getall_channelmetadata() failed on Pubnub, description: %s\n",
            getall_channelmetadata_resp);
    } else {
        printf(
            "pubnub_getall_channelmetadata() failed with code: %d('%s')\n",
            res,
            pubnub_res_2_string(res));
    }
    printf("\n\n");
    ...
    printf(
        "pubnub_get_channelmetadata() lasted %lf seconds.\n",
        difftime(time(NULL), t0));
    if (PNR_OK == res) {
        char const* get_channelmetadata_resp = pubnub_get(pbp);
        printf(
            "pubnub_get_channelmetadata() Response from Pubnub: %s\n",
            get_channelmetadata_resp);
    } else {
        printf(
            "pubnub_get_channelmetadata() failed with code: %d('%s')\n",
            res,
            pubnub_res_2_string(res));
    }
    printf("\n\n");
    ...
    printf(
        "pubnub_remove_channelmetadata() lasted %lf seconds.\n",
        difftime(time(NULL), t0));
    if (PNR_OK == res) {
        char const* remove_channelmetadata_resp = pubnub_get(pbp);
        printf(
            "pubnub_remove_channelmetadata() Response from Pubnub: %s\n",
            remove_channelmetadata_resp);
    } else {
        printf(
            "pubnub_remove_channelmetadata() failed with code: %d('%s')\n",
            res,
            pubnub_res_2_string(res));
    }
    printf("\n\n");
    ...
    time(&t0);
    include = "custom";
    char set_channelmeta_json[20000] =
        "{\"name\":\"ccorechid\",\"description\":\"ccore-channel-desc\",\"custom\":{\"foo\":\"bar\"}}";
    res = pubnub_set_channelmetadata(
        pbp,
        ch_metadata_id,
        include,
        set_channelmeta_json);
    if (PNR_STARTED == res) {
        res = pubnub_await(pbp);
    }
    printf(
        "pubnub_set_channelmetadata() lasted %lf seconds.\n",
        difftime(time(NULL), t0));
    if (PNR_OK == res) {
        char const* set_channelmetadata_resp = pubnub_get(pbp);
        printf(
            "pubnub_set_channelmetadata() Response from Pubnub: %s\n",
            set_channelmetadata_resp);
    } else {
        printf(
            "pubnub_set_channelmetadata() failed with code: %d('%s')\n",
            res,
            pubnub_res_2_string(res));
    }
    printf("\n\n");
    ...
    printf(
        "pubnub_get_memberships() lasted %lf seconds.\n",
        difftime(time(NULL), t0));
    if (PNR_OK == res) {
        char const* get_memberships_resp = pubnub_get(pbp);
        printf(
            "pubnub_get_memberships() Response from Pubnub: %s\n",
            get_memberships_resp);
    } else {
        printf(
            "pubnub_get_memberships() failed with code: %d('%s')\n",
            res,
            pubnub_res_2_string(res));
    }
    printf("\n\n");
    ...
    sprintf(
        set_membership_json,
        "[{\"channel\":{\"id\":\"%s\"},\"custom\":{\"item\":\"book\"}},{\"channel\":{\"id\":\"new-%s\"},\"custom\":{\"itemnew\":\"booknew\"}}]",
        ch_metadata_id,
        ch_metadata_id);
    res = pubnub_set_memberships(
        pbp,
        uuid_metadata_id,
        include,
        set_membership_json);
    ...
    printf(
        "pubnub_set_memberships() lasted %lf seconds.\n",
        difftime(time(NULL), t0));
    if (PNR_OK == res) {
        char const* set_memberships_resp = pubnub_get(pbp);
        printf(
            "pubnub_set_memberships() Response from Pubnub: %s\n",
            set_memberships_resp);
    } else {
        printf(
            "pubnub_set_memberships() failed with code: %d('%s')\n",
            res,
            pubnub_res_2_string(res));
    }
    printf("\n\n");
    ...
    sprintf(
        remove_membership_json,
        "[{\"channel\":{\"id\":\"%s\"}},{\"channel\":{\"id\":\"new-%s\"}}]",
        ch_metadata_id,
        ch_metadata_id);
    res = pubnub_remove_memberships(
        pbp,
        uuid_metadata_id,
        include,
        remove_membership_json);
    ...
    printf(
        "pubnub_remove_memberships() lasted %lf seconds.\n",
        difftime(time(NULL), t0));
    if (PNR_OK == res) {
        char const* remove_memberships_resp = pubnub_get(pbp);
        printf(
            "pubnub_remove_memberships() Response from Pubnub: %s\n",
            remove_memberships_resp);
    } else {
        printf(
            "pubnub_remove_memberships() failed with code: %d('%s')\n",
            res,
            pubnub_res_2_string(res));
    }
    printf("\n\n");
    ...
    printf(
        "pubnub_get_members() lasted %lf seconds.\n",
        difftime(time(NULL), t0));
    if (PNR_OK == res) {
        char const* get_members_resp = pubnub_get(pbp);
        printf(
            "pubnub_get_members() Response from Pubnub: %s\n",
            get_members_resp);
    } else {
        printf(
            "pubnub_get_members() failed with code: %d('%s')\n",
            res,
            pubnub_res_2_string(res));
    }
    printf("\n\n");
    ...
    sprintf(
        set_member_json,
        "[{\"uuid\":{\"id\":\"%s\"},\"custom\":{\"planet\":\"earth\"}},{\"uuid\":{\"id\":\"new-%s\"},\"custom\":{\"sky\":\"blue\"}}]",
        uuid_metadata_id,
        uuid_metadata_id);
    ...
    printf(
        "pubnub_set_members() lasted %lf seconds.\n",
        difftime(time(NULL), t0));
    if (PNR_OK == res) {
        char const* set_members_resp = pubnub_get(pbp);
        printf(
            "pubnub_set_members() Response from Pubnub: %s\n",
            set_members_resp);
    } else {
        printf(
            "pubnub_set_members() failed with code: %d('%s')\n",
            res,
            pubnub_res_2_string(res));
    }
    printf("\n\n");
    ...
    printf(
        "pubnub_remove_members() lasted %lf seconds.\n",
        difftime(time(NULL), t0));
    if (PNR_OK == res) {
        char const* remove_members_resp = pubnub_get(pbp);
        printf(
            "pubnub_remove_members() Response from Pubnub: %s\n",
            remove_members_resp);
    } else {
        printf(
            "pubnub_remove_members() failed with code: %d('%s')\n",
            res,
            pubnub_res_2_string(res));
    }
    printf("\n\n");
