...
enum pubnub_res
pubnub_leave(pubnub_t* p, const char* channel, const char* channel_group) {
...
enum pubnub_res
pubnub_heartbeat(pubnub_t* pb, const char* channel, const char* channel_group) {
    enum pubnub_res rslt;
...
enum pubnub_res
pubnub_here_now(pubnub_t* pb, const char* channel, const char* channel_group) {
    enum pubnub_res rslt;
...
enum pubnub_res
pubnub_remove_channel_group(pubnub_t* pb, char const* channel_group) {
    enum pubnub_res rslt;
...
enum pubnub_res
pubnub_list_channel_group(pubnub_t* pb, char const* channel_group) {
    enum pubnub_res rslt;
