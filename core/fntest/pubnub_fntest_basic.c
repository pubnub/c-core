...
TEST_DEF(connect_and_send_over_several_channels_simultaneously) {
    ...
    expect_PNR_OK(
        pbp,
        pubnub_publish(pbp, "two", "\"Test M1 - 2\""),
        10 * SECONDS);
    expect_PNR_OK(pbp, pubnub_subscribe(pbp, chan, NULL), 10 * SECONDS);
...
TEST_DEF_NEED_CHGROUP(simple_connect_and_send_over_single_channel_in_group) {
    ...
    expect_PNR_OK(
        pbp,
        pubnub_add_channel_to_group(pbp, chan, chgrp),
        10 * SECONDS);
    ...
    PUBNUB_LOG_TRACE(
        "---->pubnub_subscribe(pb=%p, chgrp) tries %d times.\n",
        pbp,
        tries);
    expect(PNR_OK == rslt);
    ...
    expect_PNR_OK(
        pbp,
        pubnub_publish(pbp, chan, "\"Test 2 - 2\""),
        10 * SECONDS);
    expect_PNR_OK(pbp, pubnub_subscribe(pbp, NULL, chgrp), 10 * SECONDS);
...
TEST_DEF_NEED_CHGROUP(
    ...
    expect_PNR_OK(
        pbp,
        pubnub_add_channel_to_group(pbp, "ch,two", chgrp),
        10 * SECONDS);
    ...
    expect_PNR_OK(
        pbp,
        pubnub_publish(pbp, "two", "\"Test M2-2\""),
        10 * SECONDS);
    expect(pnfntst_subscribe_and_check(
        pbp,
        NULL,
...
TEST_DEF_NEED_CHGROUP(
    ...
    expect_PNR_OK(
        pbp,
        pubnub_publish(pbp, "ch", "\"Test M3 - 1\""),
        10 * SECONDS);
    expect_PNR_OK(
        pbp,
        pubnub_publish(pbp, "two", "\"Test M3 - 2\""),
        10 * SECONDS);
    expect(pnfntst_subscribe_and_check(
        pbp,
        "two",
...
TEST_DEF_NEED_CHGROUP(
    ...
    expect_PNR_OK(
        pbp,
        pubnub_add_channel_to_group(pbp, "three", chgrp),
        10 * SECONDS);
    ...
    expect_PNR_OK(
        pbp,
        pubnub_publish(pbp, "ch", "\"Test M4 - ch\""),
        10 * SECONDS);
    expect_PNR_OK(
        pbp,
        pubnub_publish(pbp, "two", "\"Test M4 - two\""),
        10 * SECONDS);
    expect_PNR_OK(
        pbp,
        pubnub_publish(pbp, "three", "\"Test M4-3\""),
        10 * SECONDS);
    expect(pnfntst_subscribe_and_check(
        pbp,
        "ch,two",
...
TEST_DEF(simple_connect_and_receiver_over_single_channel) {
    ...
    expect_PNR_OK(
        pbp,
        pubnub_publish(pbp, chan, "\"Test 3 - 2\""),
        10 * SECONDS);
    expect_PNR_OK(pbp_2, pubnub_subscribe(pbp_2, chan, NULL), 10 * SECONDS);
...
TEST_DEF(connect_and_receive_over_several_channels_simultaneously) {
    ...
    expect_PNR_OK(
        pbp,
        pubnub_publish(pbp, this_test_name_, "\"M5\""),
        10 * SECONDS);
...
TEST_DEF_NEED_CHGROUP(
    ...
    expect_PNR_OK(
        pbp_2,
        pubnub_remove_channel_group(pbp_2, chgrp),
        10 * SECONDS);
    expect_PNR_OK(
        pbp_2,
        pubnub_add_channel_to_group(pbp_2, chan, chgrp),
        10 * SECONDS);
    ...
    expect_PNR_OK(
        pbp,
        pubnub_publish(pbp, chan, "\"Test 4 - 4\""),
        10 * SECONDS);
    expect_PNR_OK(pbp_2, pubnub_subscribe(pbp_2, NULL, chgrp), 10 * SECONDS);
...
TEST_DEF_NEED_CHGROUP(
    ...
    expect_PNR_OK(
        pbp_2,
        pubnub_add_channel_to_group(pbp_2, "ch,two", chgrp),
        10 * SECONDS);
    ...
    expect_PNR_OK(
        pbp,
        pubnub_publish(pbp, "two", "\"Test M6-2\""),
        10 * SECONDS);
    expect(pnfntst_subscribe_and_check(
        pbp_2,
        NULL,
...
TEST_DEF_NEED_CHGROUP(
    ...
    expect_PNR_OK(
        pbp,
        pubnub_publish(pbp, "two", "\"Test M7-2\""),
        10 * SECONDS);
    expect(pnfntst_subscribe_and_check(
        pbp_2,
        "two",
...
TEST_DEF_NEED_CHGROUP(
    ...
    expect_PNR_OK(
        pbp_2,
        pubnub_add_channel_to_group(pbp_2, "three", chgrp),
        10 * SECONDS);
    ...
    expect_PNR_OK(
        pbp_2,
        pubnub_subscribe(pbp_2, "ch,two", chgrp),
        10 * SECONDS);
    expect_PNR_OK(pbp, pubnub_publish(pbp, "ch", "\"Test M8\""), 10 * SECONDS);
    expect_PNR_OK(
        pbp,
        pubnub_publish(pbp, "two", "\"Test M8-2\""),
        10 * SECONDS);
    expect_PNR_OK(
        pbp,
        pubnub_publish(pbp, "three", "\"Test M8-3\""),
        10 * SECONDS);
    expect(pnfntst_subscribe_and_check(
        pbp_2,
        "ch,two",
...
TEST_DEF(broken_connection_test) {
    ...
    expect_PNR_OK(
        pbp,
        pubnub_publish(pbp, chan, "\"Test 6 - 2\""),
        12 * SECONDS);
...
TEST_DEF(broken_connection_test_multi) {
    ...
    expect_PNR_OK(
        pbp,
        pubnub_publish(pbp, "ch", "\"Test 7 - 2\""),
        12 * SECONDS);
    expect_PNR_OK(
        pbp,
        pubnub_publish(pbp, "two", "\"Test 8 - 2\""),
        12 * SECONDS);

    printf(
        "Test %s: Please disconnect from Internet. Press Enter when done.",
        this_test_name_);
    await_console();
    ...
    printf(
        "Test %s: Please reconnect to Internet. Press Enter when done.",
        this_test_name_);
    await_console();
    ...
    expect_PNR_OK(
        pbp,
        pubnub_publish(pbp, "ch", "\"Test 7 - 4\""),
        12 * SECONDS);
    expect_PNR_OK(
        pbp,
        pubnub_publish(pbp, "two", "\"Test 8 - 4\""),
        12 * SECONDS);
    expect_PNR_OK(pbp, pubnub_subscribe(pbp, "ch,two", NULL), 12 * SECONDS);
