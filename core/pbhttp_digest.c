...
{
    switch (e) {
    case pbhtdigqopNone: return "";
    case pbgtdigqop_auth: return "auth";
    case pbgtdigqop_auth_int: return "auth-int";
    default: return "(enum pbhttp_digest_qop)?!";
    }
}
...
{
    switch (e) {
    case pbhtdigalUnknown: return "";
    case pbhtdigalMD5: return "MD5";
    case pbhtdigalMD5_sess: return "MD5-sess";
    default: return "(enum pbhttp_digest_algorithm)?!";
    }
}


#define md5_final_to_str(x, dstr) do {                           \
