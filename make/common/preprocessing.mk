...
DEFINES_COMMON = \
    ...
    $(OPTION_PREFIX)D PUBNUB_LOG_MIN_LEVEL=$(LOG_MIN_LEVEL)                             \
    ...
    $(OPTION_PREFIX)D PUBNUB_USE_LOGGER=$(USE_LOGGER)                                 \
    $(OPTION_PREFIX)D PUBNUB_USE_DEFAULT_LOGGER=$(USE_DEFAULT_LOGGER)
