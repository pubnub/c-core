 ...
 ****************************************************/
uint8_t __attribute__((aligned(512)))
endPointTable[DRV_USBFS_ENDPOINTS_NUMBER * 32];
...
static const NET_PRES_TransportObject netPresTransObject0SS = {
    ...
    .fpHandlerRegister =
        (NET_PRES_TransHandlerRegister)TCPIP_TCP_SignalHandlerRegister,
    .fpHandlerDeregister = (NET_PRES_TransSignalHandlerDeregister)
        TCPIP_TCP_SignalHandlerDeregister,
    ...
    .fpIsPortDefaultSecure =
        (NET_PRES_TransIsPortDefaultSecured)TCPIP_Helper_TCPSecurePortGet,
};
...
static const NET_PRES_TransportObject netPresTransObject0DS = {
    ...
    .fpHandlerRegister =
        (NET_PRES_TransHandlerRegister)TCPIP_UDP_SignalHandlerRegister,
    .fpHandlerDeregister = (NET_PRES_TransSignalHandlerDeregister)
    ...
    .fpIsPortDefaultSecure =
        (NET_PRES_TransIsPortDefaultSecured)TCPIP_Helper_UDPSecurePortGet,
};
...
SYS_DEBUG_INIT debugInit = {.moduleInit = {0}, .errorLevel = SYS_ERROR_FATAL};
// </editor-fold>
...
const TCPIP_NETWORK_CONFIG __attribute__((unused))
...
const TCPIP_STACK_MODULE_CONFIG TCPIP_STACK_MODULE_CONFIG_TBL[] = {
    ...
    {TCPIP_MODULE_DHCP_CLIENT,
     &tcpipDHCPInitData},  // TCPIP_MODULE_DHCP_CLIENT,
    {TCPIP_MODULE_ANNOUNCE, &tcpipAnnounceInitData},  // TCPIP_MODULE_ANNOUNCE,
    {TCPIP_MODULE_DNS_CLIENT,
     &tcpipDNSClientInitData},  // TCPIP_MODULE_DNS_CLIENT,
    ...
    {TCPIP_MODULE_MAC_PIC32INT,
     &tcpipMACPIC32INTInitData},  // TCPIP_MODULE_MAC_PIC32INT
...
SYS_MODULE_OBJ TCPIP_STACK_Init() {
    ...
    tcpipInit.nModules = sizeof(TCPIP_STACK_MODULE_CONFIG_TBL)
...
const USB_DEVICE_FUNCTION_REGISTRATION_TABLE funcRegistrationTable[1] = {
    /* Function 1 */
    {
        ...
        .driver = (void*)
            USB_DEVICE_CDC_FUNCTION_DRIVER, /* USB CDC function data exposed to device layer */
...
const uint8_t fullSpeedConfigurationDescriptor[] = {
    ...
    67,
    0,  //(67 Bytes)Size of the Config descriptor.e
    ...
    0x10,
    0x00,  // Max packet size of this EP
    0x02,  // Interval (in ms)
...
} sd002 = {sizeof(sd002), USB_DESCRIPTOR_STRING, {'S', 'i', 'm', 'p', 'l', 'e',
                                                  ' ', 'C', 'D', 'C', ' ', 'D',
                                                  'e', 'v', 'i', 'c', 'e', ' ',
                                                  'D', 'e', 'm', 'o'}};
...
const USB_DEVICE_INIT usbDevInitData = {
    ...
    .registeredFunctions =
        (USB_DEVICE_FUNCTION_REGISTRATION_TABLE*)funcRegistrationTable,
...
void SYS_Initialize(void* data) {
    ...
    sysObj.sysDevcon = SYS_DEVCON_Initialize(
        SYS_DEVCON_INDEX_0,
    ...
    sysObj.drvUSBObject =
        DRV_USBFS_Initialize(DRV_USBFS_INDEX_0, (SYS_MODULE_INIT*)&drvUSBInit);
    ...
    sysObj.sysConsole0 = SYS_CONSOLE_Initialize(
        SYS_CONSOLE_INDEX_0,
        (SYS_MODULE_INIT*)&consUsbInit0);

    /*** Debug Service Initialization Code ***/
    sysObj.sysDebug =
        SYS_DEBUG_Initialize(SYS_DEBUG_INDEX_0, (SYS_MODULE_INIT*)&debugInit);
    ...
    sysObj.sysTmr = SYS_TMR_Initialize(
        SYS_TMR_INDEX_0,
        (const SYS_MODULE_INIT* const)&sysTmrInitData);
