...
/*** Crypto Library Configuration ***/
   ...
   function driver */
    ...
    #define TCPIP_EMAC_ETH_OPEN_FLAGS \
        TCPIP_ETH_OPEN_AUTO | TCPIP_ETH_OPEN_FDUPLEX | TCPIP_ETH_OPEN_HDUPLEX \
            | TCPIP_ETH_OPEN_100 | TCPIP_ETH_OPEN_10 \
            | TCPIP_ETH_OPEN_MDIX_AUTO | 0
    #define TCPIP_EMAC_PHY_CONFIG_FLAGS DRV_ETHPHY_CFG_AUTO | 0
